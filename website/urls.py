...
urlpatterns = [
    ...
    path('thesis-list/<str:status_filter>', views.ThesisListView.as_view(), name='thesis_list'),
    path('thesis/<slug:slug>', views.ThesisDetailView, name='thesis_detail'),
    path('thesis/<slug:slug>/approve', views.ThesisApprove, name='thesis_approve'),
    path('thesis/<slug:slug>/reject', views.ThesisReject, name='thesis_reject'),
    ...
    path('request/<slug:slug>/approve', views.RequestApprove, name='request_approve'),
